...
<p align="center">
  <img src="https://img.shields.io/badge/papers-240+-8a63d2?style=flat&labelColor=1b1b1b" alt="240+ papers">
...
<p align="center">
  <sub><b>240+ papers</b> across <b>18 topics</b> · <b>15+ community projects</b> · <b>2 runnable demos</b> · reviewed monthly · last pass <b>2026-09</b></sub>
</p>
...
- **A Survey of Agentic Reasoning for Large Language Models: Towards Recursively Self-Improving and Collective Agents** — 2026. [arXiv:2601.12538](https://arxiv.org/abs/2601.12538) · [code](https://github.com/weitianxin/Awesome-Agentic-Reasoning). Organizes agentic reasoning in three layers — single-agent foundations, self-evolving reasoning through feedback, memory, and adaptation, and collective multi-agent reasoning — and separates in-context from post-training approaches in each.
...
- **Agentic Context Engineering: Evolving Contexts for Self-Improving Language Models** — ICLR 2026. [arXiv:2510.04618](https://arxiv.org/abs/2510.04618) · [code](https://github.com/ace-agent/ace). Treats the context as an evolving playbook that is generated, reflected on, and curated in small structured increments, avoiding the brevity bias and context collapse of wholesale rewriting; +10.6% on agent benchmarks, and a widely used baseline in the harness-evolution papers below.
- **Learning to Discover at Test Time** — 2026. [arXiv:2601.16175](https://arxiv.org/abs/2601.16175) · [code](https://github.com/test-time-training/discover). Runs reinforcement learning at test time on the single problem being solved, so an open model keeps training on experience specific to it; sets new state-of-the-art results across mathematics, GPU kernels, algorithm contests, and biology for a few hundred dollars per problem.
...
- **Nested Learning: The Illusion of Deep Learning Architectures** — 2025. [arXiv:2512.24695](https://arxiv.org/abs/2512.24695). Recasts a model as nested optimization problems, each with its own context flow, and builds on that a sequence model that learns its own update rule and a continuum of memory timescales; the resulting Hope module targets continual learning rather than a fixed train-then-deploy split.
- **Learning to Continually Learn via Meta-learning Agentic Memory Designs** — 2026. [arXiv:2602.07755](https://arxiv.org/abs/2602.07755) · [code](https://github.com/zksha/alma). A meta agent searches, as open-ended executable code, over memory designs — schemas, retrieval, and update rules — instead of using a hand-built memory; the learned designs beat human-crafted ones on all four sequential decision-making domains tested.
...
- **MemSkill: Learning and Evolving Memory Skills for Self-Evolving Agents** — 2026. [arXiv:2602.02474](https://arxiv.org/abs/2602.02474) · [code](https://github.com/ViktorAxelsen/MemSkill). Turns fixed memory-extraction operations into learnable skills: a controller learns which to use, and a designer reviews hard cases and evolves the skill set itself.
- **Reinforcement Learning for Self-Improving Agent with Skill Library** — 2026. [arXiv:2512.17102](https://arxiv.org/abs/2512.17102). RL that trains skill-library use directly: rollouts chain similar tasks so skills written earlier become available later, with a reward for generating and using them; 8.9% higher goal completion on AppWorld with 59% fewer tokens.
...
- **Dr. Zero: Self-Evolving Search Agents without Training Data** — COLM 2026. [arXiv:2601.07055](https://arxiv.org/abs/2601.07055) · [code](https://github.com/facebookresearch/drzero). A proposer and a solver from the same base model co-evolve with only a search engine as their environment, the proposer rewarded for harder but still solvable questions; matches or beats fully supervised search agents without any annotated training data.
- **OpenSIR: Open-Ended Self-Improving Reasoner** — 2026. [arXiv:2511.00602](https://arxiv.org/abs/2511.00602) · [code](https://github.com/EdinburghNLP/OpenSIR). One model alternates teacher and student from a single seed problem, with diversity rewards pushing it toward unfamiliar concepts; unlike earlier self-play baselines it gains on every model tested, and it is the only self-play method in the comparison that transfers to general reasoning.
...
- **Self Improvement via Fast Tree-search** — 2026. [arXiv:2609.19526](https://arxiv.org/abs/2609.19526). Makes Gödel-machine-style self-improvement cheap: an LLM judge compares candidate self-patches pairwise, a Bradley–Terry model turns the comparisons into scores that steer the tree search, and full benchmark runs are saved for the most promising nodes. Beats prior tree-search self-evolution on Polyglot at lower cost.
- **Hill Sampling for Test-Time Scaling: A Simple and Better Alternative to Repeated Sampling, Evolution, and Training** — 2026. [arXiv:2609.25510](https://arxiv.org/abs/2609.25510). Asks how much evolutionary machinery test-time search needs. Repeatedly sampling edits to the best program so far, from a frozen model, sets a new circle-packing state of the art and beats the AlphaEvolve reference on Erdős' minimum-overlap problem, while evolution strategies on the weights do worse than a learning rate of zero.
- **Live-SWE-agent: Can Software Engineering Agents Self-Evolve on the Fly?** — 2026. [arXiv:2511.13646](https://arxiv.org/abs/2511.13646) · [code](https://github.com/OpenAutoCoder/live-swe-agent). Starts from a bash-only scaffold and evolves its own scaffold while it solves tasks, with no offline self-improvement phase: 77.4% on SWE-bench Verified without test-time scaling, and 45.8% on SWE-Bench Pro.
...
- **Hyperagents** — 2026. [arXiv:2603.19461](https://arxiv.org/abs/2603.19461) · [code](https://github.com/facebookresearch/Hyperagents). Puts the task agent and the meta agent that modifies it into one editable program, so the procedure that generates improvements is itself open to self-modification. Extends the Darwin Gödel Machine beyond coding, where task skill and self-modification skill no longer coincide; its meta-level improvements transfer across domains and accumulate across runs.
- **Recursive self-improvement of AI research agents** — 2026. [arXiv:2609.26457](https://arxiv.org/abs/2609.26457). The paper behind Weco's AIDE² post: a frontier AI research agent edits its own code, benchmarks the new versions on AI R&D tasks, and keeps what wins on hidden evaluations. An 8-day run found seven successive improvements that transfer to four held-out benchmarks, and the reward-hacking rate fell from 55% to 32% without being optimized for.
- **A mathematical theory of evolution for self-designing AIs** — 2026. [arXiv:2604.05142](https://arxiv.org/abs/2604.05142). A model of evolution for AIs that design their descendants: directed rather than random variation, with humans controlling the fitness function. If deceiving the evaluators raises fitness beyond genuine capability, selection favors both — unless reproduction rests on objective criteria.
- **On The Statistical Limits of Self-Improving Agents** — TMLR 2026. [arXiv:2510.04399](https://arxiv.org/abs/2510.04399). Splits self-modification into five axes and proves that learnability survives exactly when the capacity the agent can reach stays bounded; utility-rational self-changes can otherwise turn learnable tasks unlearnable. A two-gate guardrail restores the guarantee.
- **SGM: A Statistical Godel Machine for Risk-Controlled Recursive Self-Modification** — 2026. [arXiv:2510.10232](https://arxiv.org/abs/2510.10232). Replaces the Gödel machine's proof of improvement, unattainable in stochastic settings, with statistical tests: an edit is admitted only when its superiority is certified at a set confidence, under a global error budget across rounds.
- **AIRA_2: Overcoming Bottlenecks in AI Research Agents** — 2026. [arXiv:2603.26499](https://arxiv.org/abs/2603.26499). Removes three bottlenecks of AI research agents — synchronous single-GPU execution, noisy validation, fixed single-turn operators — and finds that the overfitting reported for long searches was evaluation noise; 81.5% percentile rank on MLE-bench-30 at 24 hours.
...
- **Grow the Harness, Not the Context: From Strategy-Free Scaffolds to Reusable Specialist Agents** — 2026. [arXiv:2609.26760](https://arxiv.org/abs/2609.26760). Starts from a scaffold with no task strategy and grows the harness from failures, each localized to a bounded code surface, with a held-out gate that rolls back regressions. Control moves out of the model's context into code: LLM calls fall by 76.0–91.8%, and a 4B model holds 44.7–45.3% on WebArena-Verified where plain tool calling falls to 6.7%.
- **Agentic Harness Engineering: Observability-Driven Automatic Evolution of Coding-Agent Harnesses** — 2026. [arXiv:2604.25850](https://arxiv.org/abs/2604.25850). Makes every harness edit falsifiable: components live as revertible files, trajectories are distilled into a drill-down evidence corpus, and each edit carries a prediction checked the next round. Terminal-Bench 2 goes from 69.7% to 77.0%; the gains sit in tools, middleware, and memory rather than the system prompt.
...
- **How Do Agent Harnesses Create Value? Planning Information and Release Control in Stateful LLM Agents** — 2026. [arXiv:2609.20474](https://arxiv.org/abs/2609.20474). Separates what a harness's parts contribute on τ²-bench: task-specific plans add 7.17 points of verified success over word-count-matched shuffled text, and a cheap read-only verifier rejects 61% of invalid episodes. Which matters more depends on the cost of accepting a wrong answer.
- **Bad Genius: Counterfactual-Guided Harness Evolution Beyond Task-Specific Shortcuts** — 2026. [arXiv:2609.18366](https://arxiv.org/abs/2609.18366). A harness optimizer tuned on a released benchmark can learn a benchmark-wide shortcut — a cheating harness. After each update, CHASE searches for validity-preserving changes to the benchmark protocol that destroy the gain, and keeps only improvements that survive them.
...
- **Large Language Model Agents Are Not Always Faithful Self-Evolvers** — ICML 2026. [arXiv:2601.22436](https://arxiv.org/abs/2601.22436). Intervenes causally on the experience given to four self-evolving frameworks across 13 backbones and finds agents rely on raw experience but often ignore condensed experience — the form most frameworks store.
- **Understanding the Challenges in Iterative Generative Optimization with LLMs** — 2026. [arXiv:2603.23994](https://arxiv.org/abs/2603.23994). Only 9% of surveyed agents use any automated optimization. Shows why: the starting artifact, how far back credit is assigned, and how trials are batched decide whether generative optimization works, and are rarely stated.
- **Can LLMs Beat Classical Hyperparameter Optimization Algorithms? A Study on autoresearch** — 2026. [arXiv:2603.24647](https://arxiv.org/abs/2603.24647) · [code](https://github.com/ferreirafabio/autoresearch-automl). On a fixed hyperparameter search space in the autoresearch setup, classical optimizers like CMA-ES and TPE beat LLM agents, which lose track of optimization state; a hybrid that shows the LLM CMA-ES's internal state does best.
...
- **Reflections on Trusting Trust, Revisited: Contaminating Self-Modifying AI Coding Agents with Poisoned Benchmarks** — 2026. [arXiv:2609.17817](https://arxiv.org/abs/2609.17817). Thompson's compiler attack, redone for agents that write their own next versions: poisoned benchmarks in the self-improvement loop led the Darwin Gödel Machine, the Self-Improving Coding Agent, and Hyperagents to evolve vulnerable behavior — one disabled HTTPS certificate validation — and the contamination often survived later evolution on clean benchmarks.
- **Self-Healing Harness for Runtime Oversight of Agent Self-Modification** — 2026. [arXiv:2609.24130](https://arxiv.org/abs/2609.24130). Treats self-modification as admission control: rules the agent writes for itself gain lasting authority only after fixing the failure that prompted them without regressing protected cases. Of 383 proposals the gate rejected on replay, 211 (55%) fixed their trigger while breaking something that had worked.
- **On Safety Risks in Experience-Driven Self-Evolving Agents** — ACL Findings 2026. [arXiv:2604.16968](https://arxiv.org/abs/2604.16968). Experience accumulated only from benign tasks still degrades safety in high-risk situations, because stored experience reinforces acting over refusing; adding refusal experience helps but causes over-refusal.
- **MemEvoBench: Benchmarking Safety Risks from Memory Misevolution in LLM Agents** — 2026. [arXiv:2604.15774](https://arxiv.org/abs/2604.15774). A benchmark for memory misevolution — behavioral drift from repeated exposure to misleading memory — across 7 domains and 36 risk types; biased memory updates cause substantial safety degradation, and static prompt defenses do not stop it.
- **Zombie Agents: Persistent Control of Self-Evolving LLM Agents via Self-Reinforcing Injections** — 2026. [arXiv:2602.15654](https://arxiv.org/abs/2602.15654). A payload read once from an attacker's web page is written into long-term memory by the agent's normal update process and later carried forward as instruction, turning one indirect injection into persistent control across sessions.
- **The Devil Behind Moltbook: Anthropic Safety is Always Vanishing in Self-Evolving AI Societies** — 2026. [arXiv:2602.09877](https://arxiv.org/abs/2602.09877). Argues, formally and with observations from an open agent community and two closed systems, that continuous self-evolution, complete isolation, and preserved safety alignment cannot hold together: isolated self-evolving societies drift from human values without external oversight.
- **SEVerA: Verified Synthesis of Self-Evolving Agents** — 2026. [arXiv:2603.25111](https://arxiv.org/abs/2603.25111) · [code](https://github.com/uiuc-focal-lab/severa). Self-evolving agent synthesis with formal guarantees: every model call is wrapped in a contract with a verified fallback, correctness is proven for all parameter values, and only then is the program tuned — zero constraint violations on the tasks tested.
- **Information-Theoretic Limits of Safety Verification for Self-Improving Systems** — 2026. [arXiv:2603.28650](https://arxiv.org/abs/2603.28650). Proves that no classifier-based safety gate can allow unbounded beneficial self-modification at bounded cumulative risk when safe and unsafe changes overlap, and that verification-based gates escape the bound.
- **Evaluating whether AI models would sabotage AI safety research** — 2026. [arXiv:2604.24618](https://arxiv.org/abs/2604.24618). Tests whether Claude models deployed as research agents inside an AI company would sabotage safety research: no unprompted sabotage, but when placed mid-trajectory in sabotage, one model continued it in 7% of cases, mostly with reasoning that did not match its output.
...
- **Beyond Endpoint Performance: Process-Level Evaluation of Self-Evolving Agents** — 2026. [arXiv:2609.24663](https://arxiv.org/abs/2609.24663). Freezes evolving memories and skills at checkpoints and tests one capability at a time on held-out episodes: gains on similar tasks weaken under distribution shift, no method adapts reliably to new rules, and the updates agents select fall short of the best candidates they generated.
- **Frontier-Eng: Benchmarking Self-Evolving Agents on Real-World Engineering Tasks with Generative Optimization** — 2026. [arXiv:2604.12290](https://arxiv.org/abs/2604.12290). 47 engineering optimization tasks with industrial simulators and continuous rewards; improvements decay as a power law in both frequency and size, and search depth matters more than width under a fixed budget.
...
- **2026-09-23 (second pass)** — Re-ran the arXiv search with a client arXiv still answers, from 2025-10 onward rather than from 2026-05, and added 36 papers the earlier passes could not see. From before May: *Hyperagents* (self-modification that edits the improver itself), *ACE*, *Nested Learning*, *TTT-Discover*, *Live-SWE-agent*, *Agentic Harness Engineering*, *ALMA*, *Dr. Zero*, *OpenSIR*, theory on the statistical limits of self-improvement and on evolution among self-designing AIs, and safety work on memory misevolution (*MemEvoBench*, *Zombie Agents*). From the last week: the AIDE² paper, *Reflections on Trusting Trust, Revisited* (poisoned benchmarks that self-modifying coding agents evolve against), *Self-Healing Harness*, *Bad Genius*, and *Hill Sampling*.
